...
6. Modelo lineal para predicción de probabilidad de aprobación  
7. Regresión logística para clasificación (aprobado vs no aprobado)  
8. Modelos con selección de variables (T-test, criterio de varianza)  
9. Modelos avanzados  
    - Árboles de decisión  
    - Random Forest  
    - SVM  
